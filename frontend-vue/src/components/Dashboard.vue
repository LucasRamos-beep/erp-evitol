...
// 1. Criamos um objeto "reativo" para guardar nossas estatísticas.
// Quando os valores aqui mudarem, o HTML atualizará automaticamente.
...
// 2. A função onMounted é executada assim que o componente é "montado" na tela.
...
onMounted(async () => {
  try {
    ...
    // 3. Atualizamos nosso objeto reativo com os dados da API.
...
<style scoped>
/* O 'scoped' significa que este CSS só se aplica a este componente */
.dashboard-grid {
  display: grid;
